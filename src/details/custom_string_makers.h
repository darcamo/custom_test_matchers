...
template <typename T, typename U> struct StringMaker<std::tuple<T, U>> {
...
template <typename T> struct StringMaker<arma::Col<T>> {
...
template <typename T> struct StringMaker<arma::Row<T>> {
...
template <typename T> struct StringMaker<arma::Mat<T>> {
