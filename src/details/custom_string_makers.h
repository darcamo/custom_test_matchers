#ifndef CPPSIM_CUSTOM_STRING_MAKERS_H
#define CPPSIM_CUSTOM_STRING_MAKERS_H
...
// xxxxxxxxxxxxxxx Catch::StringMaker specialisations xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// A specialization of Catch::StringMaker for some type will tell catch how to convert this type to a string. With this,
// the catch error messages will show our stringfied type, instead of the default "{?}" shown for types that Catch does
// not know hot to convert to string.
//
...
#endif  // CPPSIM_CUSTOM_STRING_MAKERS_H
