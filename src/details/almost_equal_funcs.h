#ifndef CPPSIM_ALMOST_EQUAL_FUNCS_H
#define CPPSIM_ALMOST_EQUAL_FUNCS_H
 ...
 *
 * Note that this function correctly changes the angles to the [0,360) interval before comparison.
...
#endif  // CPPSIM_ALMOST_EQUAL_FUNCS_H
