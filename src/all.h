...
/// @todo Replace CPPSIM in all define by the library name
...
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
// Once a specialization of Catch::MatcherBase is defined, we also need a "builder function" that we will call in the
// test code to create an object of the Catch::MatcherBase. This design of using a function to create the object of the
// correct specialization of Catch::MatcherBase is interesting because the function can have some clear name, such as
// "Equals", and be overloaded for each type to return an object of the correct specialization of Catch::MatcherBase.
//
// Note: Catch already define several overloads for an "Equals" function and we are adding more overloads here.
// Note2: The returned matcher supports bolean operator. Therefore, it is possible to use something such as
